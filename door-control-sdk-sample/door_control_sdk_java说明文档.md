...
#### 私库
- nexus地址：http://t385086941.goho.co/repository/door/
- door-control-sdk-method
- door-control-sdk-api

#### 调用
- door-control-sdk-service //springboot 主函数入口 maven添加 door-control-sdk-method
```
<dependency>
...
```
- door-control-sdk-sqagger //接口发布入口 maven添加 door-control-sdk-api
```
<dependency>
    <groupId>com.door</groupId>
